      ...
      <Modal.Footer className="justify-end">
        {demo_link && (
          <Button
            ...
            className={`${montserrat.className} font-montserrat border border-black bg-cyan-700 font-bold uppercase text-white transition ease-in-out hover:bg-cyan-900`}
          >
            Demo
          </Button>
        )}
        <Button
          ...
          className={`${montserrat.className} ${
            demo_link
              ...
              : 'font-montserrat border border-black bg-cyan-700 font-bold uppercase text-white transition ease-in-out hover:bg-cyan-900'
          }`}
        >
          Screenshot
        </Button>
  ...
  return (
    <>
      <div className="group relative flex w-full md:w-1/2 lg:w-1/3">
        ...
        <Button
          className="font-montserrat absolute left-1/2 top-1/2 z-20 -translate-x-1/2 -translate-y-1/2 border border-neutral-950 bg-cyan-700 font-bold uppercase text-white opacity-0 transition ease-in-out hover:bg-cyan-900 hover:text-white group-hover:opacity-100"
